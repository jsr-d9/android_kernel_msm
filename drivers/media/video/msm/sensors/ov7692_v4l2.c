...
static struct msm_camera_i2c_reg_conf ov7692_wb_oem[][4] = {
	...
	{{0x13, 0xf5}, {0x01, 0xa0}, {0x02, 0xb0}, {0x15, 0x00},},	/*WHITEBALNACE CUSTOM*/
	{{0x13, 0xf5}, {0x01, 0xd0}, {0x02, 0x90}, {0x15, 0x00},},	/*INCANDISCENT*/
	{{0x13, 0xf5}, {0x01, 0xa0}, {0x02, 0xb0}, {0x15, 0x00},},	/*FLOURESECT*/
	{{0x13, 0xf5}, {0x01, 0x80}, {0x02, 0xb9}, {0x15, 0x00},},	/*DAYLIGHT*/
	{{0x13, 0xf5}, {0x01, 0x70}, {0x02, 0xc5}, {0x15, 0x00},},	/*CLOUDY*/
};
